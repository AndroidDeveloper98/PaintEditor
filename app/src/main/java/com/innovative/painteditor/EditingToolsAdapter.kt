...
class EditingToolsAdapter(private val mOnItemSelected: OnItemSelected) :
    ...
    init {
        mToolList.add(ToolModel("Colors", R.drawable.color_palette, ToolType.COLORS))
        mToolList.add(ToolModel("Pencil", R.drawable.pencil, ToolType.PENCIL))
        mToolList.add(ToolModel("Line", R.drawable.line, ToolType.LINE))
        mToolList.add(ToolModel("Arrow", R.drawable.arrow_right, ToolType.ARROW))
        mToolList.add(ToolModel("Oval", R.drawable.ic_oval, ToolType.OVAL))
        mToolList.add(ToolModel("Rectangle", R.drawable.ic_rectangle, ToolType.RECTANGLE))
